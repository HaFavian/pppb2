package com.example.appwidgetsexample;
...
public class NewAppWidget extends AppWidgetProvider {
    ...
    private static final String nSharedProfile = "com.example.appwidgetsexample";
    private static final String COUNT_KEY = "count";

    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
                                int appWidgetId) {

        SharedPreferences prefs = context.getSharedPreferences(nSharedProfile, 0);
